  ...
  return (
    ...
    <footer className="bg-white dark:bg-gray-900 border-t">
      ...
      <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
        ...
        {/* 主要內容區域 - 響應式布局 */}
        {/* md:flex md:justify-between: 中等螢幕以上使用彈性布局 */}
        <div className="md:flex md:justify-between">
          
          {/* 品牌區域 - 響應式寬度和間距 */}
          {/* mb-6: 手機版下邊距 24px */}
          {/* md:mb-0: 中等螢幕以上取消下邊距 */}
          {/* md:w-1/3: 中等螢幕佔 1/3 寬度 */}
          {/* lg:w-auto: 大螢幕自動寬度 */}
          <div className="mb-6 md:mb-0 md:w-1/3 lg:w-auto">
            ...
            {/* 公司描述 - 響應式字體和最大寬度 */}
            {/* text-sm: 手機版 14px */}
            {/* sm:text-base: 平板版以上 16px */}
            {/* max-w-sm: 手機版最大寬度 384px */}
            {/* lg:max-w-xs: 大螢幕最大寬度 320px */}
            {/* xl:max-w-sm: 超大螢幕最大寬度 384px */}
          ...
          {/* 連結區域 - 響應式網格布局 */}
          {/* grid-cols-1: 手機版 1欄 */}
          {/* sm:grid-cols-3: 平板版 3欄 */}
          {/* gap-6: 基本間距 24px */}
          {/* sm:gap-6: 平板版間距 24px */}
          {/* md:gap-8: 筆電版間距 32px */}
          {/* lg:gap-6: 桌面版間距 24px */}
          {/* xl:gap-8: 大桌面版間距 32px */}
        ...
        <div className="flex flex-col items-center space-y-4 sm:flex-row sm:items-center sm:justify-between sm:space-y-0">
          ...
          {/* 版權資訊 - 響應式文字和對齊 */}
          {/* text-xs: 手機版 12px */}
          {/* sm:text-sm: 平板版以上 14px */}
          {/* text-center: 手機版置中 */}
          {/* sm:text-left: 平板版以上靠左 */}
          ...
          {/* 社交媒體圖標區域 - 響應式間距 */}
          {/* space-x-4: 手機版水平間距 16px */}
          {/* sm:space-x-5: 平板版以上水平間距 20px */}
          <div className="flex space-x-4 sm:space-x-5">
            
            {/* Facebook 連結 - 響應式圖標和懸停效果 */}
